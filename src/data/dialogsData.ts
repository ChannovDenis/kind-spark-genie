  ...
  },
  {
    ...
    issues: [
      { 
        ...
        messageId: 'msg-6', 
        category: 'protocol', 
        description: 'Пропущен скрининг на суицидальность',
        severity: 'critical'
      }
    ],
    status: 'pending',
  ...
  },
  {
    ...
    issues: [
      ...
      { 
        ...
        messageId: 'msg-4', 
        category: 'inaccuracy', 
        description: 'Ошибка в расчёте платежа',
        severity: 'warning'
      }
    ],
    status: 'pending',
